...
const PageNotFound = () => {
  return (
   ...
   <div className="flex flex-col items-center justify-center text-sm max-md:px-4">
    ...
    <p className="text-sm md:text-base mt-4 text-gray-500 max-w-md text-center">The page you are looking for might have been removed or is temporarily unavailable.</p>
